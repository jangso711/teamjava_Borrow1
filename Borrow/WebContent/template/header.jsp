...
<c:choose>
	...
	<a href="${pageContext.request.contextPath }/front?command=ItemCategorySearch&categoryNo=3002"><img id="swim" height="100" width="100"
		...
		href="${pageContext.request.contextPath }/front?command=ItemCategorySearch&categoryNo=3007"><img id="outdoor" height="100" width="100"
		src="${pageContext.request.contextPath }/img/야외스포츠.png" alt="야외"></a>
	<a href="${pageContext.request.contextPath }/front?command=ItemCategorySearch&categoryNo=3004"><img id="fishing" height="100" width="100"
	...
	<a href="${pageContext.request.contextPath }/front?command=ItemCategorySearch&categoryNo=3001"><img id="climb" height="100" width="100"
		...
		href="${pageContext.request.contextPath }/front?command=ItemCategorySearch&categoryNo=3008"><img id="baby" height="100" width="100"
