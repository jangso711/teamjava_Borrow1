...
<div class="col-sm-12 maincontent" align="center">
	...
	<br> <br> <br> <a href=""><img id="wintersports"
	...
	<a href=""><img id="swim" height="150" width="150"
		...
		href=""><img id="outdoor" height="150" width="150"
	...
	<br> <a href=""><img id="climb" height="150" width="150"
		src="${pageContext.request.contextPath }/img/등산.png" alt="등산"></a> <a
		href=""><img id="camping" height="150" width="150"
		src="${pageContext.request.contextPath }/img/캠핑.png" alt="캠핑"></a> <a
		href=""><img id="baby" height="150" width="150"
