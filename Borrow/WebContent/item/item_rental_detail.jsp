...
<div class="col-sm-4 container">    
	...
	<table>
   	 <tr>
      <td><input class="btn btn-fefault" type="button" value="홈" onclick="location.href='${pageContext.request.contextPath}/index.jsp'"></td>
      <td><input class="btn btn-fefault" type="button" value="마이페이지" onclick="location.href='${pageContext.request.contextPath}/front?command=MemberMypage'"></td>
   	 </tr>
	</table>	
	<br><br><br><br><br>
</div>
