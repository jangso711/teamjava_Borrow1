...
create table item(
	...
	constraint fk_item_id foreign key(id) references member
);
...
create table item_add(
	...
	constraint fk_item_add_item_no foreign key(item_no) references item
);
...
create table rental_details(
	...
	constraint fk_rental_details_id foreign key(id) references member,
	constraint fk_rental_details_item_no foreign key(item_no) references item
);
...
create table picture(
	...
	constraint fk_picture_item_no foreign key(item_no) references item,
...
insert into category(cat_no, cat_name) values(1, '등산용품');
insert into category(cat_no, cat_name) values(2, '물놀이용품');
insert into category(cat_no, cat_name) values(3, '캠핑용품');
insert into category(cat_no, cat_name) values(4, '겨울스포츠');
insert into category(cat_no, cat_name) values(5, '낚시용품');
insert into category(cat_no, cat_name) values(6, '야외스포츠');
insert into category(cat_no, cat_name) values(7, '유아용품');
...
create table item_category(
	...
	constraint fk_item_category_item_no foreign key(item_no) references item,
	constraint fk_item_category_cat_no foreign key(cat_no) references category,
	constraint pk_item_category primary key(item_no,cat_no) 
);

insert into ITEM_CATEGORY(item_no, cat_no) values(10001,3);  
insert into ITEM_CATEGORY(item_no, cat_no) values(10002,7);  
insert into ITEM_CATEGORY(item_no, cat_no) values(10003,7);  
